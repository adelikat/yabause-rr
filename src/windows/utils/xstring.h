...
u16 FastStrToU16(char* s, bool& valid);
char *U16ToDecStr(u16 a);
char *U32ToDecStr(u32 a);
char *U32ToDecStr(char* buf, u32 a);
char *U8ToDecStr(u8 a);
char *U8ToHexStr(u8 a);
char *U16ToHexStr(u16 a);
