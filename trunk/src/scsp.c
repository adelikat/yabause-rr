...
int SoundSaveState(FILE *fp)
{
  ...
  //zero 27-may-09: the above isnt good enough. we need to save and load ALL the state.
   ywrite(&check, (void *)&C68K.D[0], sizeof(u32), 8, fp);
   ywrite(&check, (void *)&C68K.A[0], sizeof(u32), 8, fp);
   ywrite(&check, (void *)&C68K.flag_C, sizeof(u32), 1, fp);
   ywrite(&check, (void *)&C68K.flag_V, sizeof(u32), 1, fp);
   ywrite(&check, (void *)&C68K.flag_notZ, sizeof(u32), 1, fp);
   ywrite(&check, (void *)&C68K.flag_N, sizeof(u32), 1, fp);
   ywrite(&check, (void *)&C68K.flag_X, sizeof(u32), 1, fp);
   ywrite(&check, (void *)&C68K.flag_I, sizeof(u32), 1, fp);
   ywrite(&check, (void *)&C68K.flag_S, sizeof(u32), 1, fp);
   ywrite(&check, (void *)&C68K.USP, sizeof(u32), 1, fp);
   //ywrite(&check, (void *)&C68K.PC, sizeof(pointer), 1, fp);
   //ywrite(&check, (void *)&C68K.BasePC, sizeof(pointer), 1, fp); //these needed to get regenerated by the above
   ywrite(&check, (void *)&C68K.Status, sizeof(u32), 1, fp); //these needed to get regenerated by the above
   ywrite(&check, (void *)&C68K.IRQLine, sizeof(s32), 1, fp);
   ywrite(&check, (void *)&C68K.CycleToDo, sizeof(s32), 1, fp);
   ywrite(&check, (void *)&C68K.CycleIO, sizeof(s32), 1, fp);
   ywrite(&check, (void *)&C68K.CycleSup, sizeof(s32), 1, fp);
   ywrite(&check, (void *)&C68K.dirty1, sizeof(u32), 1, fp);
   ...
   for (i = 0; i < 32; i++)
   {
	   ...
	   ywrite(&check, (void *)&scsp.slot[i].key, sizeof(u8), 1, fp);
	   ywrite(&check, (void *)&scsp.slot[i].keyx, sizeof(u8), 1, fp);

	   //need to regenerate buf8 and buf16

      ywrite(&check, (void *)&scsp.slot[i].fcnt, sizeof(u32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].finc, sizeof(u32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].finct, sizeof(u32), 1, fp);

      ywrite(&check, (void *)&scsp.slot[i].ecnt, sizeof(s32), 1, fp);
      ywrite(&check, (void *)&scsp.slot[i].einc, sizeof(s32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].einca, sizeof(s32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].eincd, sizeof(s32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].eincs, sizeof(s32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].eincr, sizeof(s32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].ecmp, sizeof(s32), 1, fp);
      ywrite(&check, (void *)&scsp.slot[i].ecurp,  sizeof(u32), 1, fp);

	  //-----complex logic for writing enxt------
      ...
      ywrite(&check, (void *)&scsp.slot[i].lfocnt, sizeof(u32), 1, fp);
      ywrite(&check, (void *)&scsp.slot[i].lfoinc, sizeof(s32), 1, fp);

	  ywrite(&check, (void *)&scsp.slot[i].sa, sizeof(s32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].lsa, sizeof(s32), 1, fp);
	  ywrite(&check, (void *)&scsp.slot[i].lea, sizeof(s32), 1, fp);
   ...
   ywrite(&check, (void *)&scsp.ca, 4, 1, fp);
...
int SoundLoadState(FILE *fp, int version, int size)
{
   ...
   //zero 27-may-09: the above isnt good enough. we need to save and load ALL the state.
   yread(&check, (void *)&C68K.D[0], sizeof(u32), 8, fp);
   yread(&check, (void *)&C68K.A[0], sizeof(u32), 8, fp);
   yread(&check, (void *)&C68K.flag_C, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.flag_V, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.flag_notZ, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.flag_N, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.flag_X, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.flag_I, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.flag_S, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.USP, sizeof(u32), 1, fp);
   //yread(&check, (void *)&C68K.PC, sizeof(pointer), 1, fp); //these needed to get regenerated by the above
   //yread(&check, (void *)&C68K.BasePC, sizeof(pointer), 1, fp); //these needed to get regenerated by the above
   yread(&check, (void *)&C68K.Status, sizeof(u32), 1, fp);
   yread(&check, (void *)&C68K.IRQLine, sizeof(s32), 1, fp);
   yread(&check, (void *)&C68K.CycleToDo, sizeof(s32), 1, fp);
   yread(&check, (void *)&C68K.CycleIO, sizeof(s32), 1, fp);
   yread(&check, (void *)&C68K.CycleSup, sizeof(s32), 1, fp);
   yread(&check, (void *)&C68K.dirty1, sizeof(u32), 1, fp);
   ...
   if (version > 1)
   {
      ...
      for (i = 0; i < 32; i++)
      {
	   ...
	   yread(&check, (void *)&scsp.slot[i].key, sizeof(u8), 1, fp);
	   yread(&check, (void *)&scsp.slot[i].keyx, sizeof(u8), 1, fp);

	   //need to regenerate buf8 and buf16

      yread(&check, (void *)&scsp.slot[i].fcnt, sizeof(u32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].finc, sizeof(u32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].finct, sizeof(u32), 1, fp);

      yread(&check, (void *)&scsp.slot[i].ecnt, sizeof(s32), 1, fp);
      yread(&check, (void *)&scsp.slot[i].einc, sizeof(s32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].einca, sizeof(s32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].eincd, sizeof(s32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].eincs, sizeof(s32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].eincr, sizeof(s32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].ecmp, sizeof(s32), 1, fp);
      yread(&check, (void *)&scsp.slot[i].ecurp,  sizeof(u32), 1, fp);

	  //-----complex logic for regenerating enxt------
      ...
      yread(&check, (void *)&scsp.slot[i].lfocnt, sizeof(u32), 1, fp);
      yread(&check, (void *)&scsp.slot[i].lfoinc, sizeof(s32), 1, fp);

	  yread(&check, (void *)&scsp.slot[i].sa, sizeof(s32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].lsa, sizeof(s32), 1, fp);
	  yread(&check, (void *)&scsp.slot[i].lea, sizeof(s32), 1, fp);
	  ...
	  yread(&check, (void *)&scsp.ca, 4, 1, fp);
